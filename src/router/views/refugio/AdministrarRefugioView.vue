...
<template>
    <div class="flex flex-row">
        ...
        <div v-else-if="menuSelected == 'datos'" class="m-3">
            <RefugioActualizarDatos class="py-5" />
        </div>
        <div v-else-if="menuSelected == 'permisos'" class="m-3 flex flex-col gap-3">
            <CambiarAdministrador class="w-3/4"></CambiarAdministrador>
            <AdministrarUsuariosRefugio></AdministrarUsuariosRefugio>
        </div>
        <div v-else-if="menuSelected == 'rechazos'">
