...
const theme = ref<SelectPassThroughOptions>({
    root: `inline-flex cursor-pointer relative select-none rounded-md p-fluid:flex
        ...
        border border-gray-300 hover:border-gray-400 dark:border-gray-700 dark:hover:border-gray-600
        p-focus:border-primary
        p-filled:bg-surface-50 dark:p-filled:bg-surface-800
        p-invalid:border-red-400 dark:p-invalid:border-red-300
        p-disabled:bg-surface-200 p-disabled:text-gray-500 dark:p-disabled:bg-surface-700 dark:p-disabled:text-gray-400 p-disabled:pointer-events-none
    ...
    label: `block whitespace-nowrap overflow-hidden flex-auto w-[1%]
        ...
        text-gray-700 dark:text-gray-0 bg-transparent border-none outline-none
        p-placeholder:text-gray-400 dark:p-placeholder:text-gray-400
        p-disabled:text-gray-500 dark:p-disabled:text-gray-400
    ...
    optionGroup: `m-0 px-3 py-2 bg-transparent text-gray-500 dark:text-gray-400 font-semibold`,
    optionGroupLabel: ``,
    option: `cursor-pointer font-normal whitespace-nowrap relative overflow-hidden flex items-center
        px-3 py-2 border-none text-gray-700 dark:text-gray-0 bg-transparent rounded-sm
        p-focus:bg-surface-100 dark:p-focus:bg-surface-800 p-focus:text-gray-800 dark:p-focus:text-gray-0
        p-selected:bg-highlight p-focus:p-selected:bg-highlight-emphasis
        transition-colors duration-200`,
    optionLabel: ``,
    optionCheckIcon: `relative -ms-[0.375rem] me-[0.375rem] text-gray-700 dark:text-gray-0`,
    optionBlankIcon: ``,
