...
const navButton = `!absolute flex-shrink-0 top-0 z-20 h-full flex items-center justify-center cursor-pointer
        bg-surface-0 dark:bg-surface-900 text-surface-500 dark:text-surface-400 hover:text-surface-900 dark:hover:text-surface-0 w-10
...
const theme = ref<TabListPassThroughOptions>({
    ...
    tabList: `relative flex  gap-2 dark:bg-surface-900
