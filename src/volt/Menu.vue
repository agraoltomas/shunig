...
const theme = ref<MenuPassThroughOptions>({
    ...
    itemContent: `group transition-colors duration-200 rounded-sm text-surface-900 dark:text-surface-0
        p-focus:bg-surface-100 dark:p-focus:bg-surface-800 p-focus:text-surface-900 dark:p-focus:text-surface-0
