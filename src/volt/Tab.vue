...
const theme = ref<TabPassThroughOptions>({
    root: `flex-shrink-0 cursor-pointer select-none relative whitespace-nowrap py-2 px-[1.125rem]
        border rounded-lg font-bold
        text-slate-500 p-active:text-primary-500
        text-xl
        transition-colors duration-200 -mb-px
        not-p-active:enabled:hover:text-surface-900 dark:not-p-active:enabled:hover:text-surface-0
