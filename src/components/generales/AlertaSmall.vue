...
const mensajeAlerta = (a: EAlerta) => {
    switch (a) {
        case EAlerta.AnimalSinReporte:
            return 'Animal sin reporte '
        case EAlerta.AnimalCritico:
            return 'Animal en estado crítico'
        case EAlerta.AnimalEnTratamiento:
            return 'Animal en tratamiento sin actualización reciente'
...
const props = withDefaults(defineProps<{ tipo: EAlerta }>(), {})
</script>
