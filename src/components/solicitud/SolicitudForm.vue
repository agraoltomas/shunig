...
<template>
    ...
    <Form v-else class="flex flex-col p-3 gap-5!" @submit="_validar" ref="form" :resolver="resolver"
          :initial-values="datosForm">
        <Contenedor>
            ...
            <FormRow :gap="6">
                ...
                <FormCol :span="6">
                    ...
                    <ToggleButton name="tiene_patio" v-model="datosForm.tiene_patio" on-label="Si"
            ...
            <FormRow :gap="6">
                <FormCol :span="6">
                    ...
                    <ToggleButton name="vive_adentro" v-model="datosForm.vive_adentro" on-label="Adentro"
                                  off-label="Afuera"></ToggleButton>
                </FormCol>
                <FormCol :span="6">
                    <Label required>¿Cuántas personas viven en el hogar?</Label>
                    <InputNumber name="cantidad_personas" v-model="datosForm.cantidad_personas" :min="1"
                                 :max="99"></InputNumber>
                </FormCol>
            </FormRow>
            <FormRow>
                <FormCol :span="6">
                    ...
                    <ToggleButton name="hay_ninios" v-model="datosForm.hay_ninios" on-label="Si"
                                  off-label="No"></ToggleButton>
                </FormCol>
            </FormRow>
        </Contenedor>
        <Contenedor>
            ...
            <FormRow :gap="6">
                <FormCol :span="3">
                    ...
                    <ToggleButton name="tuvo_mascotas" on-label="Si" off-label="No"
                                  v-model="datosForm.tuvo_mascotas"></ToggleButton>
                </FormCol>
                <FormCol :span="3">
                    <Label>¿Tiene otras mascotas?</Label>
                    <ToggleButton name="tiene_mascotas_actualmente" v-model="datosForm.tiene_mascotas_actualmente"
                                  on-label="Si"
                                  off-label="No"></ToggleButton>
                </FormCol>
                <FormCol :span="3">
                    <Label>¿Están vacunadas?</Label>
                    <ToggleButton name="mascotas_vacunadas" v-model="datosForm.mascotas_vacunadas" on-label="Si"
                                  off-label="No"></ToggleButton>
                </FormCol>
                <FormCol :span="3">
                    <Label>¿Están castradas?</Label>
                    <ToggleButton name="mascotas_castradas" v-model="datosForm.mascotas_castradas" on-label="Si"
                                  off-label="No"></ToggleButton>
                </FormCol>
            </FormRow>
        </Contenedor>
        <Contenedor>
            ...
            <FormRow :gap="6">
                ...
                <FormCol :span="6">
                    ...
                    <InputNumber placeholder="Días" name="tiempo_disponible_dias" v-model="datosForm.tiempo_disponible_dias"
                                 :min="1"></InputNumber>
                </FormCol>
            ...
            <FormRow :gap="6">
                <FormCol :span="6">
                    ...
                    <ToggleButton name="puede_cubrir_gastos" v-model="datosForm.puede_cubrir_gastos" on-label="Si"
                                  off-label="No"></ToggleButton>
                </FormCol>
            </FormRow>
        </Contenedor>
