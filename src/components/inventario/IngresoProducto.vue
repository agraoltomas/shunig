...
const initialValues = reactive<ProductoData>({
    nombre: null,
...
const resolver = ({ values }: { values: Partial<Optional<IProducto>> }) => {
    ...
    if (!initialValues.id_tipo_producto) {
    ...
    if (values.cantidad_alerta_baja === null || values.cantidad_alerta_baja === undefined) {
        errors.cantidad_alerta_baja.push({
            message: 'Ingrese la cantidad mínima de producto'
        })
    }

    if (values.cantidad_alerta_moderada === null || values.cantidad_alerta_moderada === undefined) {
        errors.cantidad_alerta_moderada.push({
            message: 'Ingrese la cantidad moderada del producto'
        })
    } else if (Number(values.cantidad_alerta_moderada) <= Number(values.cantidad_alerta_baja)) {
        errors.cantidad_alerta_moderada.push({
            message: 'La alerta moderada debe ser mayor a la baja'
        })
    }
...
<template>
    <Form
        ...
        :initialValues
        :resolver
        @submit="ingresarProducto"
        class="flex flex-col gap-5 w-full "
    >
        <div class="flex flex-row justify-between items-center px-2">
            <div class="flex flex-col">
                <div class="text-gray-600">
                    Registrá un producto general para administrar su stock, unidad y alertas.
                </div>
            </div>
        </div>
        ...
        >
            <FormRow class="w-full">
                <FormCol :span="6">
                    ...
                    <InputText
                        ...
                        fluid
                        name="nombre"
                        placeholder="Ej: Alimento balanceado adulto"
                    />
                ...
                <FormCol :span="6">
                    <Label for="tipoProducto" required>
                        Tipo de producto
                    </Label>
                    ...
                    <TableSelect
                        ...
                        v-model="initialValues.id_tipo_producto"
            ...
            <FormRow class="w-full">
                <FormCol :span="6">
                    <Label for="unidadStock" required>
                        Unidad
                    </Label>
                    ...
                    <TableSelect
                        ...
                        v-model="initialValues.id_unidad_stock"
                ...
                <FormCol :span="6">
                    ...
                    <InputText
                        ...
                        fluid
                        name="medida"
                        placeholder="Ej: 10 kg, 15 cc, 500 mg"
                    />
            ...
            <FormRow class="w-full">
                <FormCol :span="12">
                    ...
                    <Textarea
                        ...
                        :auto-resize="true"
                        rows="4"
                        placeholder="Ej: Producto destinado al stock general del refugio."
                    />
        ...
        >
            <FormRow class="w-full">
                <FormCol :span="4">
                    <Label for="cantidadAlertaBaja" required>
                        Cantidad mínima
                    </Label>

                    <InputNumber
                        id="cantidadAlertaBaja"
                        fluid
                        name="cantidad_alerta_baja"
                    />
                ...
                <FormCol :span="4">
                    <Label for="cantidadAlertaModerada" required>
                        Cantidad moderada
                    </Label>

                    <InputNumber
                        id="cantidadAlertaModerada"
                        fluid
                        name="cantidad_alerta_moderada"
                    />
                ...
                <FormCol :span="4">
                    ...
                    <div class="flex items-center gap-2 h-[42px]">
                        <ToggleSwitch
                            ...
                            v-model="initialValues.alerta_stock_activa"
                        />

                        <span>
                            {{ initialValues.alerta_stock_activa ? 'Sí' : 'No' }}
                        </span>
                    </div>
                </FormCol>
            </FormRow>
